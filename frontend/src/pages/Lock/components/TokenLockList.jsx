    ...
    <div className="w-full max-w-6xl mx-auto">
      ...
      >
        ...
        <div className="mt-4 sm:mt-0">
          <motion.button
            className="px-6 py-3 bg-gradient-to-r from-[#004581] to-[#018ABD] hover:from-[#003b6e] hover:to-[#0179a3] text-white rounded-xl transition-all duration-300 font-medium shadow-lg shadow-[#004581]/20 flex items-center gap-2 cursor-pointer"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            onClick={() => window.location.href = "/create-lock"}
          >
